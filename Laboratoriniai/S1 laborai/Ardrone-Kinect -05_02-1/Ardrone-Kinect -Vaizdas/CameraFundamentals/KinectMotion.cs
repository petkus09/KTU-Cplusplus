...
namespace CameraFundamentals
{
    public class KinectMotion
    {
        ...
        {
            if (lhand.Position.Y < chip.Position.Y && rhand.Position.Y < chip.Position.Y && lhand.Position.Z < chip.Position.Z && rhand.Position.Z < chip.Position.Z)
                return true;
            return false;
        }
       ...
       public static bool leftHandStraight(Joint head, Joint lhand, Joint lshoulder, Joint rshoulder, Joint chip)
        ...
        public static float Rotate(Joint lhand, Joint rhand, Joint lshoulder, Joint rshoulder, Joint cshoulder)
        {
            ...
            float LeftHandDisplacementZ = (lhand.Position.Z - cshoulder.Position.Z) / BasicDisplacement;
            float rot;
            rot = (LeftHandDisplacementZ - RightHandDisplacementZ) / -2;
            if (rot > -0.4 && rot < 0.4)
                rot = 0;
           if (rot > 2.5 || rot < -2.5)
                rot = 0;
        ...
        public static bool gearup(Joint lhand, Joint rhand, Joint head)
        {
            return (head.Position.X - rhand.Position.X > -0.2 && head.Position.X - rhand.Position.X < 0.2 &&
                head.Position.Y - rhand.Position.Y > -0.2 && head.Position.Y - rhand.Position.Y < 0.2 &&
                head.Position.Z - rhand.Position.Z > -0.2 && head.Position.Z - rhand.Position.Z < 0.2 && !Emergency(lhand, rhand, head));
        }
        public static bool geardown(Joint lhand, Joint rhand, Joint head)
        {
            return (head.Position.X - lhand.Position.X > -0.2 && head.Position.X - lhand.Position.X < 0.2 &&
                head.Position.Y - lhand.Position.Y > -0.2 && head.Position.Y - lhand.Position.Y < 0.2 &&
                head.Position.Z - lhand.Position.Z > -0.2 && head.Position.Z - lhand.Position.Z < 0.2 && !Emergency(lhand, rhand, head));
        }
    }
}
