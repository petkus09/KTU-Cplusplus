...
void NuskaitymoVeiksmai(ToolStripMenuItem^  skaièiuotiToolStripMenuItem, RichTextBox^  richTextBox1, Fondas * info, string p)
{
	Duomenys(info, p);
	Isvesti(info); 
...
//-----------------------------------------------------
	...
	private: System::Windows::Forms::ToolStripMenuItem^  iðsaugotiToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^  rezultatusToolStripMenuItem;
	private: System::Windows::Forms::ToolStripMenuItem^  vidurkiøRezultatusToolStripMenuItem;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->iðsaugotiToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->rezultatusToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			this->vidurkiøRezultatusToolStripMenuItem = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			// 
			this->nuskaitytiToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {this->nuskaitytiToolStripMenuItem1, 
				this->iðsaugotiToolStripMenuItem, this->toolStripSeparator1, this->iðeitiToolStripMenuItem1});
			...
			this->nuskaitytiToolStripMenuItem1->Size = System::Drawing::Size(136, 22);
			...
			// 
			// iðsaugotiToolStripMenuItem
			// 
			this->iðsaugotiToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(2) {this->rezultatusToolStripMenuItem, 
				this->vidurkiøRezultatusToolStripMenuItem});
			this->iðsaugotiToolStripMenuItem->Name = L"iðsaugotiToolStripMenuItem";
			this->iðsaugotiToolStripMenuItem->Size = System::Drawing::Size(136, 22);
			this->iðsaugotiToolStripMenuItem->Text = L"Iðsaugoti...";
			// 
			// rezultatusToolStripMenuItem
			// 
			this->rezultatusToolStripMenuItem->Name = L"rezultatusToolStripMenuItem";
			this->rezultatusToolStripMenuItem->Size = System::Drawing::Size(172, 22);
			this->rezultatusToolStripMenuItem->Text = L"Rezultatus";
			this->rezultatusToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form1::rezultatusToolStripMenuItem_Click);
			// 
			// vidurkiøRezultatusToolStripMenuItem
			// 
			this->vidurkiøRezultatusToolStripMenuItem->Name = L"vidurkiøRezultatusToolStripMenuItem";
			this->vidurkiøRezultatusToolStripMenuItem->Size = System::Drawing::Size(172, 22);
			this->vidurkiøRezultatusToolStripMenuItem->Text = L"Vidurkiø rezultatus";
			this->vidurkiøRezultatusToolStripMenuItem->Click += gcnew System::EventHandler(this, &Form1::vidurkiøRezultatusToolStripMenuItem_Click);
			// 
			// toolStripSeparator1
			// 
			...
			this->iðeitiToolStripMenuItem1->Size = System::Drawing::Size(136, 22);
...
private: System::Void nuskaitytiToolStripMenuItem1_Click(System::Object^  sender, System::EventArgs^  e) {
         ...
         NuskaitymoVeiksmai(skaièiuotiToolStripMenuItem, richTextBox1, info, dfvs);
   }

		 }
private: System::Void iðsaugotiToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {}
private: System::Void rezultatusToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {		 
   ...
   if (saveFileDialog1->ShowDialog() == System::Windows::Forms::DialogResult::OK &&
	  ...
	  fr.close();
	  RezultatuIsvedimas(infoc, rfvs);
   }
		 }
private: System::Void vidurkiøRezultatusToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
			 // Inicializuoja saveFileDialog vaizdà
   saveFileDialog1->DefaultExt = ".txt";
   saveFileDialog1->Filter = "TXT failai|*.txt";
   ...
   if (saveFileDialog1->ShowDialog() == System::Windows::Forms::DialogResult::OK &&
      ...
      ofstream fr(rfvs.c_str());
	  fr.close();
	  RezultatuIsvedimas(infoc2, rfvs);
   }
		 }
